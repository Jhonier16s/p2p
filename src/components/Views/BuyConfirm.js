    ...
    <>
      <div className="Buy-Confirm-Container">
        <div className="Buy-Confirm-CARD-Container">
          <BuyConfirmCard back_to="/BuySps" complete="Confirmar transacción"idTrade={getTrade.id} date={getTrade.created_at} buy_sell={"Comprar"} one_pridetrade={getTrade.pricetrade} trade_extra_info_payment={getTrade.extra_info_payment} />
        </div>
